...
description = """
fastapi_clone_test API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_clone_test",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_clone_test.com/terms/",
    contact={
        "name": "Acrylic125",
        "url": "http://fastapi_clone_test.com/contact/",
        "email": "Acrylic125@fastapi_clone_test.com",
    },
    license_info={
        "name": "The Unlicense",
