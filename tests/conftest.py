...
# WARNING: Ensure imports from `fastapi_clone_test` comes after this line
from fastapi_clone_test import app, settings, db  # noqa
from fastapi_clone_test.cli import create_user, cli  # noqa
